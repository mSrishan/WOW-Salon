  ...
  return (
    <footer className="bg-white text-black py-8 border-t border-gray-200">
      <div className="container mx-auto px-4 text-center">
        ...
        {/* Social Media Section with Longer Lines */}
        <div className="flex items-center justify-center space-x-12 mb-10 relative">
          {/* Left Line */}
          <div className="absolute left-0 top-1/2 w-1/3 border-t border-black transform -translate-y-1/2"></div>
          ...
          {/* Right Line */}
          <div className="absolute right-0 top-1/2 w-1/3 border-t border-black transform -translate-y-1/2"></div>
        </div>

      ...
      <div className="p-12 pr-1 max-w-8xl mx-auto bg-white">
        <div className="flex flex-col md:flex-row items-center md:justify-between gap-8">
          ...
          <div className="w-full md:w-1/4 flex justify-center">
            <Image src={home1} alt="Salon1" className="w-48 h-64 md:w-72 md:h-96" />
          </div>
        </div>
      </div>
      ...
      <div className="w-full bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="relative flex justify-center items-center">
            <div className="absolute top-0 left-[400px] transform -translate-x-1/2 -translate-y-1/2">
            ...
            <div className="absolute bottom-0 left-[350px] transform -translate-x-1/2 translate-y-1/2">
            ...
            <div className="w-[220px] h-[295px] overflow-hidden rounded-lg shadow-lg hover:scale-105 transform transition duration-300">
              <Image src={homeg3} alt="Gallery Image 3" className="w-full h-full object-cover" />
            </div>
            <div className="absolute top-0 right-[380px] transform translate-x-1/2 -translate-y-1/2">
              <div className="w-[200px] h-[160px] overflow-hidden rounded-lg shadow-lg hover:scale-105 transform transition duration-300">
